...
/*
* ## trt yolov8 sample ##
* detection using yolov8 based on tensorrt
*/
...
int main() {
    ...
    // auto yolo8_detector = std::make_shared<vp_nodes::vp_trt_yolov8_detector>("yolo8_detector", "./vp_data/models/cdy/yolov8m.engine", "./vp_data/models/coco_80classes.txt");
    ...
    auto yolo8_seg_detector = std::make_shared<vp_nodes::vp_trt_yolov8_seg_detector>("yolo8_seg_detector", "./vp_data/models/cdy/yolov8m-seg.engine", "./vp_data/models/coco_80classes.txt");
    ...
    vp_utils::vp_analysis_board board({file_src_1});
    board.display();
}